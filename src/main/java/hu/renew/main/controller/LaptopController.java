...
public class LaptopController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<LaptopResponse> update(@PathVariable Integer id,@Valid @RequestBody LaptopRequest request) {
        LaptopResponse updated = laptopService.update(id, request);
